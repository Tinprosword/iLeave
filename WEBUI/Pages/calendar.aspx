...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-xs-2" style="padding-right:0px"><asp:Button ID="btn_myself" runat="server" Text="Me"  Width="100%" Height="32px" CssClass="btnBox btnBlueBoxSelect"/></div>
        <div class="col-xs-2" style="padding-left:0px;padding-right:0px"><asp:Button ID="btn_team" runat="server" Text="Team"  Width="100%" Height="32px" CssClass="btnBox btnBlueBoxUnSelect"  /></div>
        <div class="col-xs-7" style="padding-left:25px;height:32px;line-height:32px;"><asp:CheckBox ID="cb_leave" runat="server" Text="假期" />&nbsp&nbsp&nbsp<asp:CheckBox ID="cb_holiday" runat="server" Text="更期" /></div>
