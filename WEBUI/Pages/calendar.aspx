...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-xs-12" style="margin-top:8px; margin-bottom:8px;">
            ...
            &nbsp&nbsp&nbsp<asp:RadioButton ID="cb_holiday" GroupName="leaveroster" runat="server" Text="更期" OnCheckedChanged="cb_holiday_CheckedChanged" AutoPostBack="true"/>
        </div>
        ...
        <div class="row col-xs-12" id="divTip" runat="server" visible="true">
