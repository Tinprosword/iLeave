...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <ul id="myTabApply" fixname="mytab"   class="nav nav-tabs lsf-clearPadding" runat="server">
	            ...
	            <li id="myTabapply_pending" runat="server"><a style="padding-top:4px; padding-bottom:4px;" data-toggle="tab" onclick="window.location.href='approval_wait.aspx?action=1&applicationtype=0&from=0'"><asp:Literal ID="lt_mypending" runat="server" Text="Pending"/></a></li>
                <li id="myTabapply_history" runat="server"><a style="padding-top:4px; padding-bottom:4px;" data-toggle="tab" onclick="window.location.href='approval_wait.aspx?action=1&applicationtype=3&from=0'"><asp:Literal ID="lt_myhistory" runat="server" Text="History"/></a></li>
        ...
        <div class ="col-xs-12" style="height:2px; padding:0px">&nbsp</div>
            <table class="col-xs-12 lsu-tablem1">
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="tb_date" runat="server" Width="150px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td colspan="1">
                        ...
                        <td><asp:Label ID="lb_msg" runat="server" Text="--"></td></asp:Label>
                    </td>
                </tr>
            </table>
    </div>
