        ...
        <asp:Repeater ID="rp_items" runat="server">
            <ItemTemplate>
                <div id="left" class="col-xs-12">
                    <button ID="btn_choose" runat="server" style="width:300px;height:120px;  text-align:left; background-image: url(../res/images/quare.png);background-repeat:no-repeat ;background-size:300px 120px; border: 0;background-color: transparent;"
