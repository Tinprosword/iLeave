...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-xs-12" style="padding-top:10px;padding-bottom:5px;">
            <div class="col-xs-10" style="padding-top:2px"><asp:FileUpload ID="FileUpload1" runat="server" Width="99%"  accept="*.*" Style="padding-bottom:5px;height:50px; font-size:16px;"></asp:FileUpload></div>
