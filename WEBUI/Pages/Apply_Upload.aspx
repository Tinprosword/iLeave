...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-xs-12" style="padding-top:10px;padding-bottom:5px;">
            <div class="col-xs-10" style="padding-top:2px"><asp:FileUpload ID="FileUpload1" runat="server" Width="99%" capture="camera"  Style="padding-bottom:5px;height:50px; font-size:16px;"></asp:FileUpload></div>
                        ...
                        <table>
                            <tr><td>
                                <div style="height:100px; width:100px; float:left; padding-top:10px; padding-left:2px;">
                                    <asp:ImageButton ID="ib_upload" OnClick="linkbtn_file_Click" runat="server" ImageUrl="<%# ((MODEL.App_AttachmentInfo)Container.DataItem).reduceAttendance_Image_RelatePath %>"  Height="100%" Width="100%"  CommandArgument="<%#((MODEL.App_AttachmentInfo)Container.DataItem).originAttendance_RelatePath %>"/>
                                ...
                                <div style="height:30px; width:30px; float:left; position:relative; left:-15px; top:0px;">
                                    <asp:ImageButton ID="imagebutton_close" runat="server" ImageUrl="~/Res/images/close.png" Width="100%" Height="100%" OnClick="imagebutton_close_Click" CommandArgument="<%# ((MODEL.App_AttachmentInfo)Container.DataItem).tempID %>"/>
                                </div>
                            </td>
                            </tr>
                            <tr>
