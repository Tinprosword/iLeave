        ...
        <asp:Repeater ID="rp_announctment" runat="server">
            <ItemTemplate>
                ...
                <div class="col-xs-12 divheighter" style="text-align:left; font-size:14px; font-weight:bold; padding-bottom:2px; padding-top:12px; padding-left:20px;">
                    <asp:linkbutton ID="lb_title" runat="server" OnClick="lb_title_Click"  CommandArgument="<%#((MODEL.Announcement.GirdViewData)Container.DataItem).idInTable %>" Text="<%#RP_DisplayTitle((MODEL.Announcement.GirdViewData)Container.DataItem)%>"/>
                </div>
            </ItemTemplate>
        </asp:Repeater>
    </div>
