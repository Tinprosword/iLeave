        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="col-xs-12 lsu-bigtable" style="background-image:url(res/images/login_page_bg.jpg); background-repeat:no-repeat;background-size:360px 620px; height:620px;">
                    ...
                    <tr>
                        <td></td>
                        <td colspan="2"><asp:TextBox ID="tb_user" runat="server" Width="90%" placeholder="User Name"/></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td colspan="2"><asp:TextBox ID="tb_password" runat="server" Width="90%" TextMode="Password" placeholder="Password" /></td>
                    </tr>
